                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                ?>
                                <?php
                                echo $form->field($model, 'tingkat')->widget(Select2::classname(), ['data' => ['1' => 'Tingkat A', '2' => 'Tingkat B', '3' => 'Tingkat C', '99' => 'Tingkat D'], 'options' => ['id' => 'data3', 'placeholder' => 'Pilih Tingkat'], 'pluginOptions' => ['allowClear' => true],])->label('Pilih Tingkat');
                                ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                $data7 = ArrayHelper::map(\backend\models\DafKota::find()->asArray()->all(), 'kab_id', 'nama');
                                switch ($model2->negara) {
                                    case "1":
                                        echo $form->field($model2, 'berangkat_asal')->widget(Select2::classname(), ['data' => $data7,])->label('Kota Keberangkatan');
                                        break;
                                    case "2":
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                switch ($model2->negara) {
                                    case "1":
                                        echo $form->field($model2, 'tujuan')->widget(Select2::classname(), ['data' => $data7,])->label('Kota Tujuan');
                                        break;
                                    case "2":
                            ...
                            <div class="form-group">
                                <?php
                                $prop = ArrayHelper::map(\backend\models\DafPropinsi::find()->asArray()->all(), 'propinsi_id', 'nama');
                                switch ($model2->negara) {
                                    case "1":
                                        echo $form->field($model2, 'propinsi_id')->widget(Select2::classname(), ['data' => $prop,])->label('Propinsi  Tujuan');
                                        break;
                                    case "2":
